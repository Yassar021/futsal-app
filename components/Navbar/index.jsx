            ...
            <Stack my="auto" direction={"row"} spacing="40px">
              <Link as={NextLink} href="/Home">
                <Text
                  fontSize={"18px"}
                  fontWeight="500"
                  color={isActive("/Home") ? "#1B262C" : "#A0A8B1"}
                >
                  Home
                </Text>
              </Link>
              <Link as={NextLink} href="/Inbox">
                <Text
                  fontSize={"18px"}
                  fontWeight="500"
                  color={isActive("/Inbox") ? "#1B262C" : "#A0A8B1"}
                >
              ...
              <Link as={NextLink} href="/FindTeam">
                <Text
                  fontSize={"18px"}
                  fontWeight="500"
                  color={isActive("/FindTeam") ? "#1B262C" : "#A0A8B1"}
                >
                  Find Team
                </Text>
              </Link>
              <Link as={NextLink} href="/Schedule">
                <Text
                  fontSize={"18px"}
                  fontWeight="500"
                  color={isActive("/Schedule") ? "#1B262C" : "#A0A8B1"}
                >
                  Schedule
                </Text>
              </Link>
              <Link as={NextLink} href="/History">
                <Text
                  fontSize={"18px"}
                  fontWeight="500"
                  color={isActive("/History") ? "#1B262C" : "#A0A8B1"}
                >
                  History
                </Text>
              </Link>
              <Link as={NextLink} href="/Venue">
                <Text
                  fontSize={"18px"}
                  fontWeight="500"
                  color={isActive("/Venue") ? "#1B262C" : "#A0A8B1"}
                >
                  Venue
                </Text>
              </Link>
