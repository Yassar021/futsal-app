    ...
    return(
        <Box mt='30px' py='35px' px='50px' width={'100%'} height={'210px'} borderRadius={'5px'} bgColor='#F3F4F7' boxShadow={'0px 4px 4px 0px rgba(0, 0, 0, 0.15)'}>
            <Flex direction={'row'} justifyContent={'space-between'}>
                ...
                <Box my='auto'>
                    <Stack direction={'row'}>
                        <Button  width='100px' height={'40px'} borderRadius={'2px'} bgColor={'#3282B8'} color='#fff' _hover={{ bg: '#2DCC70' }}
                            _active={{
                                bg: '#3282B8',
                        ...
                        {/* <Button  width='100px' height={'40px'} borderRadius={'2px'} bgColor={'#3282B8'} color='#fff' _hover={{ bg: '#EB5757' }}
                            _active={{
                                bg: '#3282B8',
                                transform: 'scale(0.98)',
                            }} mr={3}>
